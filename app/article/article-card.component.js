...
var ArticleCardComponent = /** @class */ (function () {
    ...
    ArticleCardComponent.prototype.setClasses = function (article) {
        return {
            'card-danger': article.isSpecial,
            'card-inverse': article.isSpecial
        };
    };
    ArticleCardComponent.prototype.buy = function (article) {
    ...
    ], ArticleCardComponent.prototype, "articles", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], ArticleCardComponent.prototype, "addToCart", void 0);
